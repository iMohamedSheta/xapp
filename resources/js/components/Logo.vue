...
<template>
  <div
    class="group flex   aspect-square size-10 items-center justify-center rounded-full text-sidebar-primary-foreground cursor-pointer">
    <WifiIcon class="text-yellow-300 fill-yellow-300 transition-all duration-300
             drop-shadow-[0_0_12px_rgba(134,0,210,0.8)] 
             animate-electric-float size-8" />
  </div>
</template>
